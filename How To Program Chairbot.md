Hello future LCC Robotics team members! This text file is designed to assist you in controlling and modifying the code of Chairbot. I hope it will enable us to continue using Chairbot for many years to come.

Please note that this file is only validated to work on the HP Windows 10 robotics laptop. Using other devices may result in instability. If you want to control Chairbot, I also recommend using the control program on the robotics laptop.
...
Chairbot is programmed using Python (to the best of my knowledge).

If you wish to modify the robot, refer to these resources to comprehend its capabilities and programming methods, as well as the appropriate file locations. Additionally, there’s a forum dedicated to the FRC that may provide valuable information.

OFFICIAL FRC DOCUMENTATION: https://docs.wpilib.org/en/stable/index.html

UNOFFICIAL FRC FORUM: https://www.chiefdelphi.com/

May Chairbot endure for many years to come. -SL
